...
public:
    ...
    ReturnStmt(Span span, std::shared_ptr<Scope> scope, std::unique_ptr<Expr> value = nullptr)
        : Stmt(span, scope), value(std::move(value)) {}
};
...
public:
    ...
    bool is_reference() const {
        return kind == Kind::Ref || kind == Kind::MutRef;
    }
